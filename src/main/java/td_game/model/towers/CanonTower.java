    ...
    public CanonTower(int x, int y,ProjectileManager projectileManager)
    {
        super(x,y,25,
                new SingleAttackStrategy(
                        new ProjectileFactory(new BasicMovementStrategy(1),new BasicPierceStrategy(5),new BasicDamageTypeStrategy(5),new BasicLifeTimeStrategy(120),new BasicRoundSizeStrategy(50,50), "Bullet"),
                        projectileManager
                ),
